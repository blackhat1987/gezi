...
class TextPredictor(object):
    ...
    def predict(self, title, content):
        ...
        libtrate.TextPredictor.Prase(title_words, id_val_map, self.identifer, 0, ngram = 3, skip = 2)
        libtrate.TextPredictor.Prase(content_words, id_val_map, self.identifer, num_words, ngram = 3, skip = 2)
