...
files = [
		  'gezi.include.python/common_util.h',  #for safe let it be first for without it file_util.h or string_util.h... will fail
...
include_paths_obsolute = [
            'app/search/sep/anti-spam/gezi/python-wrapper/include.python',
            'app/search/sep/anti-spam/melt/python-wrapper/include.python',
        	'lib2-64/wordseg', 
