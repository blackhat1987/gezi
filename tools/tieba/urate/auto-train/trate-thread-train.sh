 ./seg-trate-corpus.py ./corpus/train_spam_title ./corpus/train_spam_content ./corpus/train_nonspam_title ./corpus/train_nonspam_content title-content.segged.txt identifer.1gram.txt 
