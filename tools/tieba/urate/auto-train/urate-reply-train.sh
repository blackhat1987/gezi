...
mlt feature.reply.fixed.txt -c train -cl fr -m reply.model -vl 1 -ri 1 -rs 1024 -ntree 1500 -nl 128 -mil 50 -lr 0.025 -ff 0.3 -nbag 6 -nbagfrac 1 --mfeature=1 --mc=1 -excl ^img_
