...
_ERRNO = descriptor.EnumDescriptor(
  ...
  values=[
    ...
    descriptor.EnumValueDescriptor(
      ...
      type=None),
    descriptor.EnumValueDescriptor(
      name='EINTERNAL', index=136, number=2001,
      options=None,
      type=None),
    descriptor.EnumValueDescriptor(
      name='ERESPONSE', index=137, number=2002,
      options=None,
      type=None),
    descriptor.EnumValueDescriptor(
      name='ELOGOFF', index=138, number=2003,
      options=None,
      type=None),
    descriptor.EnumValueDescriptor(
      name='ELIMIT', index=139, number=2004,
      options=None,
      type=None),
    descriptor.EnumValueDescriptor(
      name='ECLOSE', index=140, number=2005,
      options=None,
      type=None),
  ],
