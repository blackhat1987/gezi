...
BOOST_PYTHON_MODULE(libsegment){
    ...
    { //::gezi::Segmentor
        ...
        { //::gezi::Segmentor::Init
            ...
            typedef bool ( *Init_function_type )( int,::std::string,int,::std::string,bool );
            
            Segmentor_exposer.def( 
                "Init"
                , Init_function_type( &::gezi::Segmentor::Init )
                , ( bp::arg("seg_buff_size")=(int)(gezi::SegHandle::SEG_BUFF_SIZE), bp::arg("data_dir")="./data/wordseg", bp::arg("type")=(int)(gezi::SEG_USE_DEFAULT), bp::arg("conf_path")="./conf/scw.conf", bp::arg("need_split_dict")=(bool)(false) ) );
