...
//         vector_less__gezi_scope_Feature_scope_Node__greater__exposer.def( bp::vector_indexing_suite< ::std::vector< gezi::Feature::Node > >() );
    ...
    { //::gezi::Feature
        ...
        { //::gezi::Feature::add
            ...
            typedef void ( ::gezi::Feature::*add_function_type )( ::std::vector< double > &,::std::string const & ) ;
            
            Feature_exposer.def( 
                "add"
                , add_function_type( &::gezi::Feature::add )
                , ( bp::arg("values"), bp::arg("name")="" ) );
        ...
        { //::gezi::Feature::add_sparse
        
            typedef void ( ::gezi::Feature::*add_sparse_function_type )( ::std::vector< double > & ) ;
            
            Feature_exposer.def( 
                "add_sparse"
                , add_sparse_function_type( &::gezi::Feature::add_sparse )
                , ( bp::arg("values") ) );
