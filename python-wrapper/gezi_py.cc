...
//         vector_less__token_t__greater__exposer.def( bp::vector_indexing_suite< ::std::vector< token_t > >() );
    ...
    { //::gezi::Segmentor
        ...
        Segmentor_exposer.def( bp::init< std::string, bp::optional< int, int, std::string > >(( bp::arg("data_dir"), bp::arg("seg_buff_size")=(int)(gezi::SegHandle::SEG_BUFF_SIZE), bp::arg("type")=(int)(gezi::SEG_USE_DEFAULT), bp::arg("conf_path")="./conf/scw.conf" )) );
        ...
        { //::gezi::Segmentor::init
            ...
            typedef bool ( ::gezi::Segmentor::*init_function_type )( char const *,int,char const * ) ;
            
            Segmentor_exposer.def( 
                "init"
                , init_function_type( &::gezi::Segmentor::init )
                , ( bp::arg("data_dir"), bp::arg("type")=(int)(0), bp::arg("conf_path")="./conf/scw.conf" ) );
        
        }
        { //::gezi::Segmentor::merge_newword
        
            typedef int ( ::gezi::Segmentor::*merge_newword_function_type )( ::gezi::SegHandle & ) ;
            
            Segmentor_exposer.def( 
                "merge_newword"
                , merge_newword_function_type( &::gezi::Segmentor::merge_newword )
                , ( bp::arg("handle") ) );
        
        }
        { //::gezi::Segmentor::pwdict
        
            typedef ::scw_worddict_t * & ( *pwdict_function_type )(  );
            
            Segmentor_exposer.def( 
                "pwdict"
                , pwdict_function_type( &::gezi::Segmentor::pwdict )
            , bp::return_internal_reference<>());
        ...
        { //::gezi::Segmentor::split_dict
        
            typedef ::Sdict_search * & ( *split_dict_function_type )(  );
            
            Segmentor_exposer.def( 
                "split_dict"
                , split_dict_function_type( &::gezi::Segmentor::split_dict )
            , bp::return_internal_reference<>());
        
        }
        Segmentor_exposer.def_readwrite( "_buf_size", &gezi::Segmentor::_buf_size );
        Segmentor_exposer.def_readwrite( "_flag", &gezi::Segmentor::_flag );
        Segmentor_exposer.def_readwrite( "_handle", &gezi::Segmentor::_handle );
        Segmentor_exposer.def_readwrite( "_type", &gezi::Segmentor::_type );
        Segmentor_exposer.staticmethod( "pwdict" );
        Segmentor_exposer.staticmethod( "split_dict" );
    }
    ...
    { //::gezi::seg_init
        ...
        typedef bool ( *seg_init_function_type )( ::std::string,int,::std::string );
    ...
    { //::gezi::seg_init2
        ...
        typedef bool ( *seg_init2_function_type )( ::std::string,int,::std::string );
    ...
    { //::gezi::segment
        ...
        typedef bool ( *segment_function_type )( ::std::string,::std::vector< std::string > &,::gezi::SegHandle &,int );
    ...
    { //::gezi::segment_
        ...
        typedef ::gezi::SegHandle ( *segment__function_type )( ::std::string,int );
        
        bp::def( 
            "segment_"
            , segment__function_type( &::gezi::segment_ )
            , ( bp::arg("input"), bp::arg("type")=(int)(4) ) );
    ...
    { //::gezi::segment_ts
        ...
        typedef ::std::string ( *segment_ts_function_type )( ::std::string,::std::string,int );
        
        bp::def( 
            "segment_ts"
            , segment_ts_function_type( &::gezi::segment_ts )
            , ( bp::arg("input"), bp::arg("sep"), bp::arg("type")=(int)(4) ) );
    ...
    { //::gezi::segment_ts
        ...
        typedef ::std::vector< std::string > ( *segment_ts_function_type )( ::std::string,int );
    ...
    { //::gezi::segment_ts
        ...
        typedef bool ( *segment_ts_function_type )( ::std::string,::std::vector< std::string > &,int );
